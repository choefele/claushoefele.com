...
subtitle: 'The Three Mindsets You’ll Meet at Work'
description: 'Startups require different skills (aptitude) and mindsets (attitude) than corporations. Simon Wardley identified three essential mindsets necessary for success: Explorers, Villagers, and Town Planners (formerly called Pioneers, Settlers, and Town Planners). Explorers innovate and take risks, Villagers refine and scale innovations, and Town Planners optimize and standardize mature products. Companies benefit from having all three mindsets.'
...
![Sketchnote](/d2l/explorers-villagers-town-planners.png 'Sketchnote about the Explorers, Villagers, and Town Planners concept by Simon Wardley')
...
I started on the team that built the company's flagship mobile app. While it was revered by its most active users, its reach was second to competing apps. We had a strong agil coaching team and were experimenting with OKRs, cross-functional teams, and outcome-based goals. All in an effort to scale the app to more people. And turn it into a profit center that would support its continued development.
